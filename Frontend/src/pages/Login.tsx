...
import imzge from '../assets/signin.jpg'
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-[#263238]">Welcome Back!</h2>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-sm font-medium text-[#C62828] hover:text-[#E53935]">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="text-center text-sm">
              ...
              <Link to="/register" className="ml-1 font-medium text-[#C62828] hover:text-[#E53935]">
                Sign up
              </Link>
            </div>
          </form>
